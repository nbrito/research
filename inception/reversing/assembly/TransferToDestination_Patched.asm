...
do_while:					;; 'do_while'
						;;  - there is more to do
mov	eax, [edi+08h]				;; '[edi+08h]' is the 'Array' size
						;;  - size is moved to 'eax'
shr	eax, 02h				;; 'eax' is shifted right 2 bits
cmp	ebx, eax				;; IF 'Counter' >= 'Array Index'
jge	return					;; THEN 'return'
						;; ELSE
